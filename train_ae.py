...
def parse_args():
    ...
    # basic parameters
    # parser.add_argument()是添加参数
    parser.add_argument('--model_name', type=str, default='Sae', help='the name of the model')
    parser.add_argument('--data_name', type=str, default='CWRUFFT', help='the name of the data')
    parser.add_argument('--data_dir', type=str, default="/D:\Mydata\CWRU", help='the directory of the data')
    parser.add_argument('--normlizetype', type=str, choices=['0-1', '1-1', 'mean-std'], default="0-1",
                        help='data pre-processing ')
    ...
    parser.add_argument('--epsilon', type=float, default=0.1, help='parameter of LAP')
